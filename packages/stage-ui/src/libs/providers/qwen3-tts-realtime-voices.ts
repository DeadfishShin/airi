...
export const QWEN3_TTS_REALTIME_VOICE_CATALOG = [
  ...
  { id: 'Shanghai - Jada', name: 'Shanghai - Jada', description: 'A fast-paced, energetic Shanghai auntie.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Shanghainese' }, ...standardLanguages.slice(1)], gender: 'female', languageNotes: 'Official dialect: Shanghainese.' },
  { id: 'Beijing - Dylan', name: 'Beijing - Dylan', description: 'A young man raised in Beijing’s hutongs.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Beijing dialect' }, ...standardLanguages.slice(1)], gender: 'male', languageNotes: 'Official dialect: Beijing dialect.' },
  { id: 'Nanjing - Li', name: 'Nanjing - Li', description: 'A patient yoga teacher.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Nanjing dialect' }, ...standardLanguages.slice(1)], gender: 'male', languageNotes: 'Official dialect: Nanjing dialect.' },
  { id: 'Shaanxi - Marcus', name: 'Shaanxi - Marcus', description: 'An authentic Shaanxi voice: broad face, few words, sincere heart, and deep voice.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Shaanxi dialect' }, ...standardLanguages.slice(1)], gender: 'male', languageNotes: 'Official dialect: Shaanxi dialect.' },
  { id: 'Southern Min - Roy', name: 'Southern Min - Roy', description: 'A humorous, straightforward, lively Taiwanese guy.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Southern Min' }, ...standardLanguages.slice(1)], gender: 'male', languageNotes: 'Official dialect: Southern Min.' },
  { id: 'Tianjin - Peter', name: 'Tianjin - Peter', description: 'Tianjin-style crosstalk, professional foil.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Tianjin dialect' }, ...standardLanguages.slice(1)], gender: 'male', languageNotes: 'Official dialect: Tianjin dialect.' },
  { id: 'Sichuan - Sunny', name: 'Sichuan - Sunny', description: 'A Sichuan girl sweet enough to melt your heart.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Sichuan dialect' }, ...standardLanguages.slice(1)], gender: 'female', languageNotes: 'Official dialect: Sichuan dialect.' },
  { id: 'Sichuan - Eric', name: 'Sichuan - Eric', description: 'A Sichuanese man from Chengdu who stands out in everyday life.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Sichuan dialect' }, ...standardLanguages.slice(1)], gender: 'male', languageNotes: 'Official dialect: Sichuan dialect.' },
  { id: 'Cantonese - Rocky', name: 'Cantonese - Rocky', description: 'A humorous, witty A Qiang providing live chat.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Cantonese' }, ...standardLanguages.slice(1)], gender: 'male', languageNotes: 'Official dialect: Cantonese.' },
  { id: 'Cantonese - Kiki', name: 'Cantonese - Kiki', description: 'A sweet Hong Kong girl best friend.', compatibleModels: flashOnly, languages: [{ code: 'zh', title: 'Cantonese' }, ...standardLanguages.slice(1)], gender: 'female', languageNotes: 'Official dialect: Cantonese.' },
